...
pub fn create_presale_handler(ctx: Context<CreatePresale>, args: CreatePresaleArgs) -> Result<()> {
    ...
    msg!(
        "currentTime :{} & start Time: {} end Time: {}",
    ...
    require!(current_unix_timestamp < args.start_time, PresaleErrorCodes::InvalidTime);

    require!(args.end_time > args.start_time, PresaleErrorCodes::InvalidTime);
    require!(
